...
class PandaSimSolution(PandaSim):
    ...
    def block_pose_to_gripper_pose(self, block_pose):
        ...
        # Create the offset transformation matrix
        H = np.eye(4)  # 4x4 identity matrix
        H[:3, :3] = R  # Set rotation part
        H[:3, 3] = t   # Set translation part
        
        # Calculate final gripper pose by multiplying block pose with offset
        gripper_pose = block_pose @ H
